...
def test_openrouter_base_url_applies_or_headers(mock_openai):
    ...
    assert headers["HTTP-Referer"] == "https://github.com/berdaya/berdaya-agent"
    assert headers["X-Title"] == "Berdaya Agent"
...
def test_user_default_headers_win_over_provider_defaults(mock_openai):
    ...
    assert headers["HTTP-Referer"] == "https://github.com/berdaya/berdaya-agent"  # default preserved

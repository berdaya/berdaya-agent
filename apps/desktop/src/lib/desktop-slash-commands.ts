...
/** Why a known Berdaya Agent command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/version', description: 'Show Berdaya Agent version', surface: exec() },
 ...
 * Berdaya Agent' built-in slash commands — i.e. skill commands (`/gif-search`,

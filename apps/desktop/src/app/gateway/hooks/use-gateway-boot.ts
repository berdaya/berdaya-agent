...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Berdaya Agent...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Berdaya Agent…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Berdaya Agent gateway". resolveGatewayWsUrl

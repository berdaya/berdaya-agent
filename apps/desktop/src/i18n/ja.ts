...
export const ja = defineLocale({
  ...
  boot: {
    ready: 'Berdaya Agent Desktop の準備ができました',
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: '起動中に Berdaya Agent バックグラウンドプロセスが終了しました。',
    ...
    failure: {
      title: 'Berdaya Agent を起動できませんでした',
      description:
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'デスクトップバックエンドがそのリクエストを拒否しました (405 Method Not Allowed)。Berdaya Agent Desktop を再起動してください。',
  ...
  settings: {
    ...
    resetConfirm: 'すべての設定を Berdaya Agent のデフォルトに戻しますか？',
    ...
    searchPlaceholder: {
      about: 'Berdaya Agent Desktop について',
      config: '設定を検索…',
      gateway: 'ゲートウェイ接続…',
      keys: 'API キーを検索…',
      mcp: 'MCP サーバーを検索…',
    ...
    appearance: {
      ...
      colorMode: 'カラーモード',
      colorModeDesc: '固定モードを選ぶか、Berdaya Agent をシステム設定に合わせます。',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Berdaya Agent がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
        imageInputMode: '画像添付をモデルへ送る方法を制御します。',
        maxTurns: 'Berdaya Agent が 1 回の実行を停止するまでのツール呼び出しターン上限です。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'Berdaya Agent が 1 回のファイル読み取りで取得できる最大文字数です。',
      approvals: {
        mode: '明示的な承認が必要なコマンドを Berdaya Agent がどう扱うかを設定します。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'アプリから Berdaya Agent 自身を更新するとき、ローカルのソース変更を保持するか破棄するかを選びます。ターミナル更新では常に確認されます。'
      }
    }),
    about: {
      heading: 'Berdaya Agent Desktop',
      ...
      automaticUpdatesDesc: 'Berdaya Agent はバックグラウンドで自動的に更新を確認し、利用可能になったら通知します。',
    ...
    config: {
      ...
      loading: 'Berdaya Agent の設定を読み込み中...',
    ...
    gateway: {
      ...
      intro:
        'Berdaya Agent Desktop はデフォルトで独自のローカルゲートウェイを起動します。別のマシンや信頼できるプロキシの背後で既に動作している Berdaya Agent バックエンドをこのアプリで制御する場合は、リモートゲートウェイを使用してください。以下でプロファイルを選択して、それぞれのリモートホストを設定します。',
      appliesTo: '適用対象',
      ...
      localDesc: 'ローカルホストでプライベートな Berdaya Agent バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
      remoteTitle: 'リモートゲートウェイ',
      remoteDesc:
        'このデスクトップシェルをリモートの Berdaya Agent バックエンドに接続します。ホスト型ゲートウェイは OAuth またはユーザー名とパスワードを使用します。自己ホスト型はセッショントークンを使用する場合があります。',
      ...
      restartingMessage: 'Berdaya Agent Desktop は保存された設定を使用して再接続します。',
      savedMessage: '次回起動時に保存されます。',
      connectedTo: (baseUrl, version) => `${baseUrl}${version ? ` · Berdaya Agent ${version}` : ''} に接続しました`,
    ...
    providers: {
      ...
      intro:
        'サブスクリプションでサインインします。API キーのコピーは不要です。Berdaya Agent がアプリ内でブラウザーサインインを代行します。',
      connected: '接続済み',
      collapse: '折りたたむ',
  ...
  profiles: {
    ...
    title: 'プロジェクト',
    count: count => `${count} プロジェクト`,
    loading: 'プロジェクトを読み込み中...',
    newProfile: '新しいプロジェクト',
    allProfiles: 'すべてのプロジェクト',
    showAllProfiles: 'すべてのプロジェクトを表示',
    switchToProfile: name => `${name} に切り替え`,
    manageProfiles: 'プロジェクトを管理...',
    actionsFor: name => `${name} のアクション`,
    color: 'カラー...',
    colorFor: name => `${name} のカラー`,
    setColor: color => `カラー ${color} に設定`,
    autoColor: '自動',
    noProfiles: 'プロジェクトが見つかりません。',
    selectPrompt: '詳細を表示するにはプロジェクトを選択してください。',
    refresh: 'プロジェクトを更新',
    ...
    skillsLabel: 'スキル',
    notSet: '未設定',
    projectDesc: 'このプロジェクトに組み込まれたシステムプロンプトと指示（PROJECT.md）。',
    descriptionLabel: 'プロジェクトの説明',
    descriptionOptional: '省略可能',
    descriptionPlaceholder: 'このプロジェクトは何のためのものですか？',
    unsavedChanges: '未保存の変更',
    loadingProject: 'PROJECT.md を読み込み中...',
    emptyProject: '空の PROJECT.md — プロジェクトの指示を書き始めてください...',
    saving: '保存中...',
    saveProject: 'PROJECT.md を保存',
    deleteTitle: 'プロジェクトを削除しますか？',
    deleteDescPrefix: 'これにより ',
    deleteDescMid: ' が削除され、その ',
    deleteDescSuffix: ' ディレクトリが削除されます。この操作は元に戻せません。',
    deleting: '削除中...',
    createDesc: 'プロジェクトは独立した Berdaya Agent ワークスペースです：設定、スキル、PROJECT.md が別々になります。',
    nameLabel: 'プロジェクト名',
    cloneFromDefault: 'デフォルトプロジェクトから設定を複製',
    cloneFromDefaultDesc: 'デフォルトプロジェクトから設定、スキル、PROJECT.md をコピーします。',
    invalidName: hint => `無効なプロジェクト名。${hint}`,
    nameRequired: 'プロジェクト名は必須です',
    creating: '作成中...',
    createAction: 'プロジェクトを作成',
    renameTitle: 'プロジェクトの名前を変更',
    renameDescPrefix: '名前を変更するとプロジェクトディレクトリと ',
    ...
    projectSaved: 'PROJECT.md を保存しました',
    failedLoad: 'プロジェクトの読み込みに失敗しました',
    failedDelete: 'プロジェクトの削除に失敗しました',
  ...
  cron: {
    ...
    newCron: '新しい Cron',
    emptyDescNew:
      'Cron 式でプロンプトを実行するスケジュールを設定します。Berdaya Agent が実行して、選択した宛先に結果を送信します。',
  ...
  composer: {
    ...
    placeholderStarting: 'Berdaya Agent を起動中...',
    placeholderReconnecting: 'Berdaya Agent に再接続中…',
    placeholderFollowUp: 'フォローアップを送信',
    newSessionPlaceholders: [
      '何を作りますか？',
      'Berdaya Agent にタスクを与える',
      '何か考えていることはありますか？',
      '必要なことを説明してください',
      '何に取り組みますか？',
      '何でも聞いてください',
    ...
    attachUrlDesc: 'Berdaya Agent がページを取得し、このターンのコンテキストとして含めます。',
  ...
  updates: {
    ...
    unsupportedMessage: 'このバージョンの Berdaya Agent はアプリ内から自分を更新できません。',
    ...
    availableBody: '新しいバージョンの Berdaya Agent をインストールする準備ができています。',
    availableTitleBackend: 'バックエンドの更新があります',
    availableBodyBackend: '接続中の Berdaya Agent バックエンドの新しいバージョンをインストールできます。',
    ...
    manualBody:
      'Berdaya Agent をコマンドラインからインストールしたため、更新もそこで実行されます。これをターミナルに貼り付けてください:',
    manualPickedUp: 'Berdaya Agent は次回起動時に新しいバージョンを読み込みます。',
    copy: 'コピー',
    copied: 'コピーしました',
    done: '完了',
    applyingBody: 'Berdaya Agent アップデーターが独自のウィンドウで引き継ぎ、完了後に Berdaya Agent を再度開きます。',
    applyingBodyBackend: 'リモートバックエンドが更新を適用して再起動します。復帰すると Berdaya Agent が自動的に再接続します。',
    applyingClose: 'Berdaya Agent は更新を適用するために閉じます。',
  ...
  install: {
    ...
    oneTimeTitle: 'Berdaya Agent には一度限りのインストールが必要です',
    ...
    settingUpTitle: 'Berdaya Agent を設定中',
    finishingTitle: '仕上げ中',
    failedDesc:
      'インストール手順のいずれかが失敗しました。Windows では、別の Berdaya Agent CLI またはデスクトップインスタンスが実行中の場合に発生することがあります。実行中の Berdaya Agent インスタンスをすべて停止してから再試行してください。詳細は以下またはデスクトップログで確認できます。',
    activeDesc:
      'これは一回限りのセットアップです。Berdaya Agent インストーラーが依存関係をダウンロードしてマシンを設定しています。以降の起動ではこの手順はスキップされます。',
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'セルフホスト',
        description:
          'ローカルまたはセルフホストの OpenAI 互換エンドポイント（vLLM、llama.cpp、Ollama など）に Berdaya Agent を接続。'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'ブラウザーで確認ページを開きます — Berdaya Agent が自動接続します',
      loopback: 'サインインのためブラウザーを開きます — Berdaya Agent が自動接続します',
    ...
    authorizeThere: 'そこで Berdaya Agent を承認してください。',
    copyAuthCode: '認証コードをコピーして以下に貼り付けてください。',
    pasteAuthCode: '認証コードを貼り付け',
    reopenAuthPage: '認証ページを再度開く',
    autoBrowser: provider =>
      `${provider} をブラウザーで開きました。Berdaya Agent をそこで承認すれば自動接続されます。コピーや貼り付けは不要です。`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Berdaya Agent Desktop v${version}`,
      ...
      gatewayTitle: 'Berdaya Agent 推論ゲートウェイのステータス',
      agents: 'エージェント',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} は ${size} です。Berdaya Agent は最初の 512 KB のみを表示します。`,
    ...
    web: {
      ...
      tryAgain: '再試行',
      restarting: 'Berdaya Agent を再起動中...',
      askRestart: 'Berdaya Agent にサーバーの再起動を依頼',
      lookingRestart: taskId => `Berdaya Agent は再起動するプレビューサーバーを検索中です (${taskId})`,
      restartingTitle: 'プレビューサーバーを再起動中',
      restartingMessage: 'Berdaya Agent はバックグラウンドで作業中です。進捗はプレビューコンソールで確認してください。',
      ...
      finishedRestarting: message =>
        `Berdaya Agent がプレビューサーバーの再起動を完了しました${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Berdaya Agent がサーバーを再起動できませんでした。',
      stillWorking:
        'Berdaya Agent はまだ作業中ですが、再起動の結果がまだ届いていません。サーバーコマンドがフォアグラウンドで実行されている可能性があります。',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Berdaya Agent が応答を読み込み中',
      thinking: '考え中',
      today: time => `今日 ${time}`,
    ...
    approval: {
      gatewayDisconnected: 'Berdaya Agent ゲートウェイが接続されていません',
      ...
      alwaysDescription: pattern =>
        `これにより "${pattern}" パターンが永続的な許可リスト (~/.hermes/config.yaml) に追加されます。Berdaya Agent はこのセッションや将来のセッションで、このようなコマンドについて再度尋ねません。`,
      alwaysAllow: '常に許可'
    },
    clarify: {
  ...
  prompts: {
    ...
    sudoTitle: '管理者パスワード',
    sudoDesc:
      'Berdaya Agent は特権コマンドを実行するために sudo パスワードが必要です。ローカルエージェントにのみ送信されます。',
    sudoPlaceholder: 'sudo パスワード',
    secretTitle: 'シークレットが必要です',
    secretDesc: 'Berdaya Agent は続行するための認証情報が必要です。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '画像を保存するには Berdaya Agent Desktop を再起動してください。',
    restartToSaveImages: '画像を保存するには Berdaya Agent Desktop を再起動してください',

...
export const en: Translations = {
  ...
  boot: {
    ready: 'Berdaya Agent Desktop is ready',
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'Berdaya Agent background process exited during startup.',
    ...
    failure: {
      title: "Berdaya Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Berdaya Agent Desktop.',
  ...
  keybinds: {
    ...
    actions: {
      ...
      'profile.default': 'Switch to default project',
      'profile.switch.1': 'Switch to project 1',
      'profile.switch.2': 'Switch to project 2',
      'profile.switch.3': 'Switch to project 3',
      'profile.switch.4': 'Switch to project 4',
      'profile.switch.5': 'Switch to project 5',
      'profile.switch.6': 'Switch to project 6',
      'profile.switch.7': 'Switch to project 7',
      'profile.switch.8': 'Switch to project 8',
      'profile.switch.9': 'Switch to project 9',
      'profile.switch.10': 'Switch to project 10',
      'profile.switch.11': 'Switch to project 11',
      'profile.switch.12': 'Switch to project 12',
      'profile.switch.13': 'Switch to project 13',
      'profile.switch.14': 'Switch to project 14',
      'profile.switch.15': 'Switch to project 15',
      'profile.switch.16': 'Switch to project 16',
      'profile.switch.17': 'Switch to project 17',
      'profile.switch.18': 'Switch to project 18',
      'profile.next': 'Next project',
      'profile.prev': 'Previous project',
      'profile.toggleAll': 'Toggle all-projects view',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Berdaya Agent defaults?',
    ...
    searchPlaceholder: {
      about: 'About Berdaya Agent Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Berdaya Agent follow your system setting.',
      ...
      themeProfileNote: profile => `Saved for the ${profile} project — each project keeps its own theme.`,
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Berdaya Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Berdaya Agent configuration...',
    ...
    gateway: {
      ...
      intro:
        'Berdaya Agent Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Berdaya Agent backend on another machine or behind a trusted proxy. Pick a project below to give it its own remote host.',
      appliesTo: 'Applies to',
      allProfiles: 'All projects',
      defaultConnection: 'Default connection for every project that has no override of its own.',
      profileConnection: profile =>
        `Connection used only when “${profile}” is the active project. Set it to Local to inherit the default.`,
      ...
      localDesc: 'Start a private Berdaya Agent backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Berdaya Agent backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Berdaya Agent Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Berdaya Agent ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Berdaya Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  profiles: {
    ...
    newProfile: 'New project',
    allProfiles: 'All projects',
    showAllProfiles: 'Show all projects',
    switchToProfile: name => `Switch to ${name}`,
    manageProfiles: 'Manage projects...',
    actionsFor: name => `Actions for ${name}`,
    color: 'Color...',
    colorFor: name => `Color for ${name}`,
    setColor: color => `Set color ${color}`,
    autoColor: 'Auto',
    noProfiles: 'No projects yet.',
    selectPrompt: 'Select a project to view its details.',
    ...
    skillsLabel: 'Skills',
    notSet: 'Not set',
    projectDesc: 'The system prompt and instructions baked into this project (PROJECT.md).',
    descriptionLabel: 'Project description',
    descriptionOptional: 'optional',
    descriptionPlaceholder: 'What is this project for?',
    unsavedChanges: 'Unsaved changes',
    loadingProject: 'Loading PROJECT.md...',
    emptyProject: 'Empty PROJECT.md — start writing project instructions...',
    saving: 'Saving...',
    saveProject: 'Save PROJECT.md',
    deleteTitle: 'Delete project?',
    deleteDescPrefix: 'This will delete ',
    deleteDescMid: ' and remove its ',
    deleteDescSuffix: ' directory. This cannot be undone.',
    deleting: 'Deleting...',
    createDesc: 'Projects are independent Berdaya Agent workspaces: separate config, skills, and PROJECT.md.',
    nameLabel: 'Project name',
    cloneFromDefault: 'Clone from default',
    cloneFromDefaultDesc: 'Copy config, skills, and PROJECT.md from your default project.',
    invalidName: hint => `Invalid name. ${hint}`,
    nameRequired: 'Project name is required.',
    creating: 'Creating...',
    createAction: 'Create project',
    renameTitle: 'Rename project',
    renameDescPrefix: 'Renaming updates the project directory and any wrapper scripts in ',
    renameDescSuffix: '.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Berdaya Agent will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Berdaya Agent...',
    placeholderReconnecting: 'Reconnecting to Berdaya Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Berdaya Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Berdaya Agent will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      restart: 'Restarting Berdaya Agent…',
    ...
    unsupportedMessage: 'This version of Berdaya Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Berdaya Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Berdaya Agent backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Berdaya Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Berdaya Agent will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Berdaya Agent updater will take over in its own window and reopen Berdaya Agent when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Berdaya Agent reconnects automatically when it’s back.',
    applyingClose: 'Berdaya Agent will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Berdaya Agent needs a one-time install',
    ...
    settingUpTitle: 'Setting up Berdaya Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Berdaya Agent CLI or desktop instance is running. Stop any running Berdaya Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Berdaya Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Berdaya Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Berdaya Agent connects automatically',
      loopback: 'Opens your browser to sign in — Berdaya Agent connects automatically',
    ...
    authorizeThere: 'Authorize Berdaya Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Berdaya Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Berdaya Agent inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Berdaya Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Berdaya Agent is restarting...',
      askRestart: 'Ask Berdaya Agent to restart the server',
      lookingRestart: taskId => `Berdaya Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Berdaya Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Berdaya Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Berdaya Agent could not restart the server.',
      stillWorking:
        'Berdaya Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Berdaya Agent is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Berdaya Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Berdaya Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Berdaya Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Berdaya Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    profileStatus: current =>
      `Project: ${current}. Use /profile <name> or the "New session" picker to start a chat in another project.`,
    unknownProfile: 'Unknown project',
    noProfileNamed: (target, available) => `No project named "${target}". Available: ${available}`,
    newChatsProfile: name => `New chats will use project ${name}.`,
    setProfileFailed: 'Failed to set project',
    ...
    restartToUseSaveImage: 'Restart Berdaya Agent Desktop to use Save Image.',
    restartToSaveImages: 'Restart Berdaya Agent Desktop to save images',
